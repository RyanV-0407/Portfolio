...
export const NotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-ink text-background flex flex-col items-center justify-center font-mono p-6">
      ...
      <div className="border border-primary/30 p-8 md:p-12 max-w-lg w-full bg-card shadow-2xl relative overflow-hidden animate-fade-in animation-delay-200">
        ...
        <div className="text-primary mb-2 text-sm opacity-80">vikram@server:~$ cd /requested-route</div>
        <div className="text-rust mb-8 text-sm">bash: cd: /requested-route: No such file or directory</div>
